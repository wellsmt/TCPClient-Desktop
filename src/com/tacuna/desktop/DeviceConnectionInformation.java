...
public class DeviceConnectionInformation {
     ...
     * 
     * @param host
     *            The devices host name or IP address
     * @param port
     *            The devices port (i.e 9760).
     * @param macAddress
     */
    public DeviceConnectionInformation(String host, int port,
	    String macAddress, String name, long timestamp) {
	super();
	this.host = host;
	this.port = port;
